...
app.post('/api/auth/login', async (req, res) => {
  try {
    ...
    // Para demo, aceptar cualquier contraseña
    if (password !== 'demo123') {
      return res.status(401).json({ error: 'Credenciales inválidas' });
    }
...
<body>
    ...
    <div class="auth-modal" id="authModal">
        <div class="auth-box">
            <h1>🌐 CyberZid</h1>
            <input type="email" id="authEmail" placeholder="Email" value="demo@cyberzid.com">
            <input type="password" id="authPassword" placeholder="Contraseña" value="demo123">
            <button onclick="login()">Iniciar Sesión</button>
            <button onclick="toggleRegister()" style="background: transparent; color: #06b6d4; border: 1px solid #06b6d4; margin-top: 10px;">Crear Cuenta</button>
        </div>
    </div>
    ...
    <script>
        ...
        function toggleRegister() {
            alert('Usa el formulario de login con credenciales de prueba: demo@cyberzid.com / demo123');
        }
